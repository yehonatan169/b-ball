...
DOCTEST_MSVC_SUPPRESS_WARNING(4640) // construction of local static objects is not thread-safe
// static analysis
...
namespace detail {
    ...
    String rawMemoryToString(const void* objects, unsigned size) {
        ...
        unsigned const char* bytes = static_cast<unsigned const char*>(objects);
        std::ostringstream   oss;
